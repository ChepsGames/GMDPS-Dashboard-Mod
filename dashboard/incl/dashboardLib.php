					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
							...
							<a class="dropdown-item dontblock" href="lang/switchLang.php?lang=EN"><div class="icon flag"><img class="imgflag" src="incl/flags/us.png?2"></div>English</a>
                        			    	<a class="dropdown-item dontblock" href="lang/switchLang.php?lang=BR" title="Translated by ChepsGames"><div class="icon flag"><img class="imgflag" src="incl/flags/br.png?2"></div>Português (Brasil)</a>
